#!/bin/bash
#SBATCH --job-name=LAW_test_vis
#SBATCH --output=LAW_test_vis_%j.out
#SBATCH --error=LAW_test_vis_%j.err
...
python tools/test_for_vis.py projects/configs/law/default.py checkpoints/perception-free/LAW.pth --launcher none --out results/result_for_vis.pkl

# 可視化の実行
echo "Generating visualization..."
python /home/shunya.seiya/mlops_ws/VAD/tools/analysis_tools/visualization.py --result-path results/result_for_vis.pkl --save-path visualization_results
