...
# LAWモデルの予測結果を可視化するスクリプト

# SLURM設定
#SBATCH --job-name=LAW_vis
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --time=01:00:00
#SBATCH --gres=gpu:1
#SBATCH -e law_vis_%j.err
#SBATCH -o law_vis_%j.out
...
python tools/visualize_prediction.py \
    ...
    --framerate 2 \
    projects/configs/law/default.py  \
    checkpoints/perception-free/LAW.pth 
